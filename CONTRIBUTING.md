...
Additionally once you have contributed to WhatsMyName you can contribute
to the packaged version with accepted changes. 


# WhatsMyName (Base Repos)
...
# WhatsMyNamePackage (This Repo)

Create a fork with any programming changes and create a request for the changes to be merged into this repository.
